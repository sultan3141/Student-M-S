                        ...
                        <Menu as="div" className="relative ml-2 sm:ml-4 border-l border-white/10 pl-4 flex items-center">
                            ...
                            >
                                <Menu.Items className="absolute right-0 top-full mt-4 w-72 origin-top-right divide-y divide-gray-100 rounded-[2rem] bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden z-50 transform border-8 border-white">
                                    ...
                                    <div className="bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#1E3A8A] p-10 flex flex-col items-center">
                                        <div className="w-28 h-28 rounded-full bg-white p-1.5 shadow-2xl mb-6 ring-8 ring-white/10">
                                        ...
                                        <h3 className="text-white font-black text-2xl tracking-tighter uppercase mb-1">Welcome!</h3>
                                        <div className="h-0.5 w-12 bg-blue-400/50 rounded-full mb-2"></div>
                                        <p className="text-blue-200 text-xs font-bold truncate w-full text-center opacity-80 px-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <Menu.Item>
                                                {({ active }) => (
                                                    <Link
                                                        href={route('student.profile.edit')}
                                                        className={`${active ? 'bg-[#1E40AF] scale-[1.02]' : 'bg-[#1D4ED8]'} flex flex-col items-center justify-center p-4 rounded-2xl text-white transition-all shadow-lg shadow-blue-900/10 group h-full`}
                                                    >
                                            ...
                                            <Menu.Item>
                                                {({ active }) => (
                                                    <Link
                                                        ...
                                                        className={`${active ? 'bg-amber-600 scale-[1.02]' : 'bg-amber-500'} flex flex-col items-center justify-center p-4 rounded-2xl text-white transition-all shadow-lg shadow-amber-900/10 group h-full`}
                                                    >
                                                        <KeyIcon className="h-6 w-6 mb-2" />
                                        ...
                                        <Menu.Item>
                                            {({ active }) => (
                                                <Link
                                                    ...
                                                    method="post"
                                                    as="button"
                                                    className={`${active ? 'bg-red-700 scale-[1.02]' : 'bg-red-600'} flex items-center justify-center space-x-3 p-4 rounded-2xl text-white transition-all shadow-lg shadow-red-900/10 w-full group`}
                                                >

                    ...
                    <div className="flex h-16 justify-between items-center">
                        ...
                        <div className="flex flex-1 items-center lg:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-white/80 hover:text-white transition-colors focus:outline-none"
                            >
                                <svg
                                    className="h-6 w-6"
                                    stroke="currentColor"
                        ...
                        {/* Desktop Nav Links - Removed for Minimalism */}
                        <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex flex-1">
                            {/* Minimalism: Nav links are handled via specialized role portals or mobile menu */}
                        </div>

                        {/* Right Side - Actions/Logout (lg breakpoint) */}

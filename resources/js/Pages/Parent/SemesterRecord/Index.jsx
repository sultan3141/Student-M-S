...
const SemesterCard = memo(({ sem, studentId }) => {
    const href = route('parent.academic.semester.show', {
        studentId: studentId,
    ...
    return (
        <Link
            ...
            onMouseEnter={() => {
                ...
                window.dispatchEvent(new CustomEvent('inertia:prefetch', { detail: { url: href } }));
            }}
        >
            <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-sm border border-indigo-50">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                <div className="space-y-1">
                    ...
                    <div className="flex items-baseline space-x-1">
                        <p className="text-2xl font-black text-indigo-700">{sem.average}</p>
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-gray-600">Review your child's academic journey across all completed semesters</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 lg:p-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-indigo-100 uppercase tracking-wider">Student Name</p>
                                    <p className="font-bold text-lg">{student.user?.name || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-center space-x-3">
                                <div className="p-2 bg-white/20 rounded-lg">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-indigo-100 uppercase tracking-wider">Student ID</p>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-indigo-100 uppercase tracking-wider">Grade</p>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-indigo-100 uppercase tracking-wider">Section</p>

...
export default function Create({ grades }) {
    ...
    const handleSectionChange = async (e) => {
        ...
        if (sectionId && data.grade_id) {
            try {
                const response = await fetch(`/registrar/assessment-types/subjects?grade_id=${data.grade_id}&section_id=${sectionId}`);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('registrar.assessment-types.store'));
    };

    return (
        <RegistrarLayout>
            <Head title="Create Assessment Type" />
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 flex justify-between items-center">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">CREATE ASSESSMENT TYPE</h1>
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        <h2 className="text-lg font-semibold mb-6">Assessment Type Details</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4 flex gap-3">
                                ...
                                >
                                    {processing ? 'Creating...' : 'Create Assessment Type'}
                                </button>
                                <Link
                                    href={route('registrar.assessment-types.index')}

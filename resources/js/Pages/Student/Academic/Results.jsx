            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tbody>
                            {subjectPerformance && subjectPerformance.length > 0 ? subjectPerformance.map((performance, index) => (
                                <tr key={index} className="hover:bg-gray-50">
                                    <td className="border border-gray-300 px-4 py-3 text-sm">{index + 1}</td>
                                    <td className="border border-gray-300 px-4 py-3 text-sm">
                                        <span className="text-blue-600">({performance.subject.code})</span> {performance.subject.name}
                                    </td>
                                    <td className="border border-gray-300 px-4 py-3 text-sm text-center">{performance.subject.code}</td>
                                    ...
                                    <td className="border border-gray-300 px-4 py-3 text-sm text-center font-bold">
                                        {performance.max_score > 0
                                            ? ((performance.total_score / performance.max_score) * 100).toFixed(0)
